...
public class TravelClaimRegistration {
    ...
    /** Input field for the brand of the customers credit card. */
    private TextField creditCardBrandField;
    /** Input field for the country of where the damage happened. */
    ...
    public TravelClaimRegistration() {
        ...
        Text insurancesTitle = new Text("Velg forsikringen til skademelding:");
        ...
        mainPane.add(creditCardBrandLabel, 8, 13, 2, 1);
...
} // end of class TravelClaimRegistration
