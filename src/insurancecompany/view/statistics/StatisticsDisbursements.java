...
/**
 * This class creates the graphical user interface (GUI) for showing disbursement 
 * statistics.
 * 
...
public class StatisticsDisbursements {
    ...
    public StatisticsDisbursements() {
        ...
        firstPane.add(claimTypeLabel, 0, 6);
        firstPane.add(claimTypeCombo, 1, 6);
    ...
    /**
     * @param disable the disable to be set
     */
